...
- **教材頁專注於閱讀內容**：移除「閱讀內容／教材詞彙」切換器、教材詞彙列表、搜尋及批次勾選介面；既有詞彙學習紀錄、首頁統計、備份資料與正文熟悉度效果仍會保留。
...
- 教材庫提供搜尋、排序與學習進度摘要；正文熟悉度使用固定的深靛藍描邊與淡金流光，與閱讀標記背景清楚分層。
- 閱讀頁會辨識英文正文與相鄰中文翻譯；每段左上方依序提供閱讀位置、翻譯顯示／隱藏及英文複製工具。
